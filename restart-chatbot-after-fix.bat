@echo off
echo =======================================================
echo    KHỞI ĐỘNG LẠI FRONTEND VÀ KIỂM TRA SỬA LỖI CHATBOT
echo =======================================================
echo.
color 0A
...
if !ERRORLEVEL! neq 0 (
    ...
    start cmd /k "%rootDir%\start-chatbot.bat"
...
echo.
echo CÁC SỬA ĐỔI ĐÃ ĐƯỢC THỰC HIỆN:
echo - Đã sửa điều kiện kiểm tra về thanh toán
echo - Đã thay đổi thứ tự kiểm tra các điều kiện
echo - Đã cải thiện nhận diện tin nhắn chào hỏi
echo - Đã thêm nhiều log debug chi tiết
echo.
echo Bạn có thể:
echo 1. Truy cập http://localhost:3000 để kiểm tra chatbot
echo 2. Chạy các bài test với lệnh test-chatbot-accuracy.bat
echo =======================================================
echo.
