        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchCategory = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ResultsCount = table.Column<int>(type: "int", nullable: false),
                    HasClickedResult = table.Column<bool>(type: "bit", nullable: false),
                    ClickedResultId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClickedResultType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IpAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserAgent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerSearchStatistics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerSearchStatistics_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerSearchStatistics_UserId",
                table: "CustomerSearchStatistics",
                column: "UserId");
        }
