      ...
      <section className="py-20 container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-6 text-slate-300">
              <p className="flex items-start gap-3">
                ...
                <span>Tầng 11, số 300 Đê La Thành nhỏ, Thổ Quan, Đống Đa, Hà Nội</span>
              </p>
              
              <p className="flex items-start gap-3">
                <Clock className="h-5 w-5 text-red-500 mt-1 flex-shrink-0" />
                <span>
                  <span className="block">6:00 - 22:00, Thứ 2 - Chủ Nhật</span>
                </span>
              </p>
              ...
              <p className="flex items-start gap-3">
                ...
                <span>
                  <a href="tel:08999139393" className="hover:text-white transition-colors">
                    08999139393
                  </a>
                </span>
              </p>
            ...
            <Button size="lg" className="mt-8 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white border-none" asChild>
              <a 
                href="https://www.google.com/maps/dir/?api=1&destination=Tầng+11,+số+300+Đê+La+Thành+nhỏ,+Thổ+Quan,+Đống+Đa,+Hà+Nội" 
                target="_blank"
                rel="noopener noreferrer"
              >
                <span className="flex items-center gap-2">
          ...
          <div className="relative">
            <GoogleMap height="400px" className="rounded-lg shadow-xl border border-slate-700" />
          </div>
        </div>
      </section>
    </main>
