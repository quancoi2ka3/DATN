...
interface SportswearSidebarProps {
  products: Product[];
...
export function SportswearSidebar({ 
  products,
  selectedCategories,
  onCategoryChange,
  priceRange,
      ...
      <div className="mb-6">
        ...
        {expandedSections.price && (
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <button
                onClick={() => handlePriceChange(0, 500000)}
              ...
              <button
                onClick={() => handlePriceChange(1500000, 2000000)}
                className={`w-full text-left px-3 py-2 rounded text-sm ${
                  priceRange[0] === 1500000 && priceRange[1] === 2000000 
                    ? 'bg-red-500 text-white' 
                    : 'bg-slate-800 text-slate-300 hover:bg-slate-700'
                }`}
              >
